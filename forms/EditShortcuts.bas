        ...
        Begin Section
            ...
            Begin
                ...
                Begin Subform
                    ...
                    Height =6120
                    TabIndex =1
                    Name ="SpeciesShortcutSubform"
                    SourceObject ="Form.SpeciesShortcutSubform"
                ...
                Begin Subform
                    ...
                    Height =6120
                    TabIndex =2
                    Name ="DetailsShortcutSubform"
                    SourceObject ="Form.DetailsShortcutSubform"
                    ...
                    Begin
                        Begin Label
                            ...
                            BackColor =16252927
                            ForeColor =7169897
                            Name ="DetailsShortcutSubform Label"
                            Caption ="Detail Shortcuts"
                            FontName ="Franklin Gothic Book"
                            EventProcPrefix ="DetailsShortcutSubform_Label"
                            LayoutCachedLeft =4920
                            LayoutCachedTop =60
...
DoCmd.Close acForm, "EditShortcuts", acSaveNo
Exit Sub

ErrHandler:
    ErrorMsg "The Shortcut form encountered an error.", _
...
HelpMsg Me.Name, "Keyboard Shortcuts"
...
If rs.RecordCount > 0 Then
    ...
    End If
End If
'Check detail shortcuts
Set rs = db.OpenRecordset("SELECT Count(DetailID) As Num, Shortcut, " & _
    "SpeciesID FROM DetailsRecSource WHERE (((Shortcut) Is Not Null)) " & _
    "GROUP BY Shortcut, SpeciesID ORDER BY Count(DetailID);")
If rs.RecordCount > 0 Then
    rs.MoveLast
    If rs!Num > 1 Then
...
ErrHandler:
    ErrorMsg "An error occurred when attempting to check for " & _
        "duplicate shortcuts.", Err.Number, Err.Description
    Cancel = False
    Resume UnloadExit
