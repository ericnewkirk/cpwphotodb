...
Begin Form
    ...
    RecSrcDt = Begin
        0xb11759842d55e440
    End
    RecordSource ="DetectionDetails"
    Caption ="MergeDetails"
        ...
        Begin FormHeader
            ...
            Begin
                Begin Label
                    ...
                    Name ="Label2"
                    Caption ="Merge Photo ID Details"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin ComboBox
                    ...
                    TabIndex =1
                    BorderColor =7169897
                    Name ="cboDetailToKeep"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT DetectionDetails.DetailID, DetectionDetails.DetailText FROM DetectionDeta"
                        "ils WHERE (((DetectionDetails.DetailID)<>[Forms]![MergeDetails]![DetailID]) AND "
                        "((DetectionDetails.SpeciesID)=DLookUp(\"SpeciesID\",\"DetectionDetails\",\"Detai"
                        "lID=\" & [Forms]![MergeDetails]![DetailID]))) ORDER BY DetectionDetails.DetailTe"
                        "xt;"
                    ColumnWidths ="0;1440"
                    AfterUpdate ="[Event Procedure]"
                ...
                Begin TextBox
                    ...
                    TabIndex =2
                    ForeColor =2366701
                    Name ="txtDetailToKeepReqd"
                    ControlSource ="=IIf([cboDetailToKeep] Is Null,\"*\",\"\")"
...
Private Sub cboDetailToKeep_AfterUpdate()
'Enable merge button

If IsNull(Me.DetailID) Or IsNull(Me.cboDetailToKeep) Then
...
DoCmd.Close acForm, "MergeDetails"
...
HelpMsg Me.Name, "Merging Details"
...
strSQL = "UPDATE Photos INNER JOIN Detections ON " & _
    ...
    "(((Detections.DetailID)=" & Me.DetailID & _
    ") Or ((Detections.DetailID)=" & Me.cboDetailToKeep & "));"
db.Execute strSQL
'Switch existing detections to remaining detail
DoCmd.SetWarnings False
strSQL = "UPDATE Detections SET Detections.DetailID = " & _
    Me.cboDetailToKeep & " WHERE (((Detections.DetailID)=" & _
    Me.DetailID & "));"
Set db = CurrentDb
db.Execute strSQL
'Display results
...
Private Sub DetailID_AfterUpdate()
'Enable merge button
...
If IsLoaded("DetectionDetails") Then
    Cancel = False
Else
    Cancel = True
    MsgBox "This form can only be accessed from the Detail List Form."
End If
