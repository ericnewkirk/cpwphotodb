        ...
        Begin FormHeader
            ...
            Begin
                ...
                Begin Label
                    ...
                    BorderColor =5029044
                    ForeColor =16252927
                    Name ="StudyAreaDescription_Label"
                    Caption ="Description"
                    FontName ="Franklin Gothic Book"
                    Tag ="DetachedLabel"
                    ColumnGroup =1
                ...
                Begin TextBox
                    ...
                    ForeColor =2366701
                    Name ="txtNameReqd"
                    ControlSource ="=IIf([StudyAreaName] Is Null,\"*\",\"\")"
        ...
        Begin Section
            ...
            Begin
                ...
                Begin TextBox
                    ...
                    ControlSource ="StudyAreaDescription"
                    ColumnGroup =1
                    GroupTable =4
...
HelpMsg Me.Name, "Study Areas Help"
...
If MsgBox("Are you sure you want to delete this record?" & _
    vbNewLine & vbNewLine & "All location, visit, and photo " & _
    "data for this study area will be deleted as well.", _
...
'Check for name and abbreviation

On Error GoTo ErrHandler

If IsNull(Me.StudyAreaName) Then
    'Prevent saving record
    Cancel = True
    If MsgBox("You must enter a name for this study area.", _
        vbOKCancel, "Name Required") = vbOK Then
        'Return to record
        Me.StudyAreaName.SetFocus
    Else
        'Discard record
        Me.Undo
    End If
Else
    If IsNull(Me.StudyAreaAbbr) Then
        'Use name as default abbreviation
        Me.StudyAreaAbbr = Me.StudyAreaName
    End If
    'Save record
    Cancel = False
End If
...
ErrHandler:
    ErrorMsg "An error occurred while saving changes.", _
