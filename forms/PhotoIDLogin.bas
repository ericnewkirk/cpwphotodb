...
Begin Form
    ...
    RecSrcDt = Begin
        0xcdd35723f437e440
    End
    RecordSource ="CurrentObserver"
    Caption ="PhotoIDLogin"
        ...
        Begin Section
            ...
            Begin
                Begin ComboBox
                    ...
                    BorderColor =7169897
                    Name ="ObserverID"
                    ControlSource ="ObserverID"
                    RowSourceType ="Table/Query"
                    RowSource ="SELECT Observers.ObserverID, [FirstName] & \" \" & [LastName] AS [Full Name] FRO"
                        "M Observers ORDER BY Observers.LastName, Observers.FirstName;"
                    ColumnWidths ="0;1440"
                    ...
                    Begin
                        Begin Label
                            ...
                            BackColor =16252927
                            ForeColor =7169897
                            Name ="ObserverID_Label"
                            Caption ="Enter or select your name:"
...
Private Const strGenericError As String = _
    "The Login form encountered an error."

Private Sub cmdCancel_Click()
'Cancel saving record and close form
...
Call ObserverID_AfterUpdate

End Sub

Private Sub ObserverID_AfterUpdate()
'Enable/disable go button

On Error GoTo ErrHandler

Me.cmdGo.Enabled = Not IsNull(Me.ObserverID)
Exit Sub
...
Private Sub ObserverID_NotInList(NewData As String, Response As Integer)
'Allow adding new observer to table

On Error GoTo ErrHandler

If MsgBox("The name you entered is not in the observers list." & vbNewLine & _
    "Do you want to add it?", vbYesNo, "Name not found") = vbYes Then
    'Open observers form
    DoCmd.OpenForm "Observers", acNormal, , , acFormAdd, acDialog, NewData
