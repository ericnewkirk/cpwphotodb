dbMemo "SQL" ="SELECT IndependentDetections.IndDetectionID, IndependentDetections.SpeciesID, In"
    ...
    "\012FROM IndependentDetections LEFT JOIN IndividualDetections ON IndependentDete"
    "ctions.IndDetectionID = IndividualDetections.IndDetectionID\015\012WHERE (((Inde"
    "pendentDetections.Deleted)=False) AND ((IndividualDetections.ID) Is Null))\015\012"
    "ORDER BY IndependentDetections.LocationID, IndependentDetections.ModifiedStart;\015"
    "\012"
dbMemo "Connect" =""
