...
Begin OutputColumns
    ...
    Alias ="UTM_E"
    Expression ="First(CameraLocations.UTM_E)"
    Alias ="UTM_N"
    Expression ="First(CameraLocations.UTM_N)"
    Alias ="Zone"
    Expression ="First(CameraLocations.UTMZone)"
    Alias ="Datum"
    Expression ="First(CameraLocations.UTMDatum)"
    Alias ="Hemisphere"
    Expression ="First(Nz([CameraLocations].[UTMHemisphere],'N'))"
End
Begin Joins
